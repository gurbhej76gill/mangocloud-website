...
1. Visit the CLA portal linked from the repository README.
2. Authenticate with GitHub and review the agreement.
3. Submit the form; the bot will update your PR status automatically.
