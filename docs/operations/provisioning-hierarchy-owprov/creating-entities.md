...
- Organize devices by location/organization (example: Company -> City -> Site).
- Enable configuration inheritance (Entity/Venue configs contribute to final device configuration).
