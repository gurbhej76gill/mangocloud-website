...
- Create a separate tenant/organization so customers or teams are managed separately.
- Keep Entities, Venues, Subscribers, and devices grouped under the correct Operator.
- Limit user access by assigning users to an Operator.
